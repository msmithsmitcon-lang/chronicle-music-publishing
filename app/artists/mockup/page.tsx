...
const features = [
  ...
  ["Premium Publishing", "Excellence in every note. Integrity in every deal.", "medal"],
] as const;
      ...
      <section className={styles.scene}>
        ...
        <div className={styles.showcaseGrid}>
          ...
          <article className={styles.studioCard}>
            ...
            <div className={styles.studioCopy}>
              <p className={styles.cardEyebrow}>Catalogue Context</p>
              <h2>
                Studio-rooted
                <span>Representation</span>
              </h2>
              <p className={styles.role}>For selected works.</p>
              <p className={styles.bodyText}>
                From songwriters to recording artists, we provide publishing
                administration, rights management and strategic representation.
              </p>
              <Link href="/catalogue" className={styles.goldPill}>
        ...
        <footer className={styles.nowPlaying}>
          ...
          <div className={styles.playerVisual}>
            <Waveform compact />
            <div className={styles.controls} aria-label="Decorative player controls">
              <button type="button" aria-label="Previous preview">‹</button>
              <button type="button" aria-label="Play preview" className={styles.playButton}>▶</button>
