  ...
  return (
    <main>
      ...
      <section className="section-shell px-4 py-6 md:px-8 md:py-8">
        <div className="relative mx-auto min-h-[42rem] max-w-[96rem] overflow-hidden rounded-[0.62rem] border border-[rgba(217,170,73,0.28)] bg-black p-6 shadow-[0_22px_70px_rgba(0,0,0,0.55),inset_0_0_0_1px_rgba(255,255,255,0.03)] md:p-8">
          ...
          <div className="relative z-10 grid min-h-[38rem] gap-5 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="flex h-full flex-col justify-between">
              <div className="max-w-[43rem]">
                <p className="eyebrow">Featured Catalogue</p>
                <h2 className="brand-heading mt-5 text-[clamp(2.7rem,4.2vw,4.8rem)] leading-[0.93] tracking-[-0.055em] text-ivory">
                  The works of M-WIS.
                ...
                <p className="mt-6 max-w-[31rem] text-lg leading-8 text-[rgba(248,241,223,0.82)]">
