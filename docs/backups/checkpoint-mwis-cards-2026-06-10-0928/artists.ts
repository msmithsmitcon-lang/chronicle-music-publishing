...
export const artistProfiles: ArtistProfile[] = [
  {
    ...
    publishingFocus: [
      "Representation of original musical works",
      "Production and catalogue development",
      "Licensing and commercial opportunities",
      "Long-term catalogue preservation",
    ],
    metadata: {
      role: "Producer • Songwriter • Creator",
      catalogueStatus: "Selected represented works",
      territory: "South Africa • International licensing enquiries",
  ...
  },
  {
    ...
    publishingFocus: [
      "Production identity",
      "Representation of original musical works context",
